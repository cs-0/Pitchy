...
class NoteSpec: QuickSpec {
    ...
    func spec() {
        Self.describe("Note.Letter") {
            Self.describe(".values") {
                Self.it("returns an array of 12 note letters") {
                    let letters = Note.Letter.values
                    expect(letters.count).to(equal(12))
                }
                
                Self.it("returns an array of notes in the correct order") {
                    let letters = Note.Letter.values
        ...
        Self.describe("Note") {
            ...
            Self.describe("#init") {
                ...
                Self.it("creates note with index") {
                    notes.forEach {
                ...
                Self.it("creates note with frequency") {
                    notes.forEach {
                ...
                Self.it("creates note with letter and octave") {
                    notes.forEach {
